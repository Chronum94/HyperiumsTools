...
tag = '[Panic]'
today, yesterday = '20170818', '20170819'
game = 'Hyperiums8'
...
panic_tagged_yeste = planets_in_alliance(planet_data_yeste, tag, cluster=3)
panic_tagged_today = planets_in_alliance(planet_data_today, tag, cluster=3)
